...
(function() {
  var JcDecauxKey, mapboxKey, staticList;
  ...
  staticList = [
    {
      ...
      "latitude": 48.910143671003794,
      "longitude": 2.385052018244114
    }, {
      "number": 5005,
      ...
      "address": "115 rue de provence - 75009 PARIS",
      "latitude": 48.874179024030234,
      "longitude": 2.327778690118609
    }, {
      "number": 8008,
      ...
      "number": 19022,
      "name": "19022 - BOLIVAR",
      "address": "53 RUE DE MEAUX - 75019 PARIS",
      "latitude": 48.881447321103366,
      "longitude": 2.3734047671616
    }, {
      "number": 35008,
      ...
      "number": 20029,
      "name": "20029 - PORTE DES LILAS",
      "address": "57 RUE DES FRERES FLAVIEN - 75020 PARIS",
      "latitude": 48.87809927643587,
      "longitude": 2.411046298532085
    }, {
      "number": 22101,
      ...
      "number": 17001,
      "name": "17001 - GUY MOCQUET",
      "address": "RUE GUY MOCQUET - 75017 PARIS",
      "latitude": 48.89282296302349,
      "longitude": 2.326803489834799
    }, {
      "number": 1010,
      ...
      "latitude": 48.855965856210226,
      "longitude": 2.356381154873061
    }, {
      "number": 20117,
      ...
      "number": 12025,
      "name": "12025 - BERCY",
      "address": "FACE 14 PL. DU BATAILLON DU PACIFIQUE - 75012 PARIS",
      "latitude": 48.84026772485455,
      "longitude": 2.379519527723101
    }, {
      "number": 16107,
      "name": "16107 - GODARD",
      ...
      "address": "FETE DE L'OH (BERCY) - QUAI MAURIAC ANG PONT DE BERCY - 75013 PARIS",
      "latitude": 48.8371336894515,
      "longitude": 2.37434055460561
    }, {
      "number": 16105,
      "name": "16105 - CREVAUX",
      ...
      "number": 15006,
      "name": "15006 - CHERCHE MIDI",
      "address": "FACE AU 138 RUE DU CHERCHE MIDI - 75015 PARIS",
      "latitude": 48.844575963933345,
      "longitude": 2.317756579232021
    }, {
      "number": 19013,
      "name": "19013 - LAUMIERE",
      ...
      "number": 14017,
      "name": "14017 - JOURDAN TOMBE ISSOIRE",
      "address": "160 RUE TOMBE ISSOIRE - 75014 PARIS",
      "latitude": 48.822782442043376,
      "longitude": 2.330537540381845
    }, {
      "number": 2001,
      ...
      "number": 9006,
      "name": "09006 - TRUDAINRE ROCHECHOUART",
      "address": "81 RUE DUNKERQUE - 75009 PARIS",
      "latitude": 48.88210763435887,
      "longitude": 2.346261998538882
    }, {
      "number": 16006,
      ...
      "number": 20014,
      "name": "20014 - ALEXANDRE DUMAS",
      "address": "142 BD CHARONNE - 75020 PARIS",
      "latitude": 48.85616737956336,
      "longitude": 2.394825009354706
    }, {
      "number": 10013,
      ...
      "latitude": 48.84799219346147,
      "longitude": 2.296681685691776
    }, {
      "number": 5106,
      "name": "05106 - CUJAS",
      ...
      "number": 17006,
      "name": "17006 - GUY MOCQUET DAVY",
      "address": "34 RUE GUY MOCQUET - 75017 PARIS",
      "latitude": 48.892064086245426,
      "longitude": 2.323291341208543
    }, {
      "number": 7006,
  ...
  mapboxKey = 'pk.eyJ1Ijoia3NhZCIsImEiOiJubmpQc2NBIn0.41AawrAmH2vSER5mdqY8xg';
  JcDecauxKey = '9aee25ea0d38e36783872cb7755b45d0c659ad4a';

  (function() {
    return window.Request = (function() {
      function Request() {
        var e;
      ...
      Request.prototype.alertContents = function(model) {
        var response;
      ...
      Request.prototype.makeRequest = function(url, model) {
        console.log(this.alertContents);
        this.httpRequest.onreadystatechange = (function(_this) {
          return function() {
            return _this.alertContents(model);
          };
        })(this);
        this.httpRequest.open('GET', url);
        this.httpRequest.send();
        console.log("Sending");
        return console.log(this.httpRequest);
      };
  ...
  (function() {
    var format;
    window.VelibList = (function() {
      function VelibList(List) {
        this.List = List;
      }

      VelibList.prototype.addMarker = function(L, map) {
        var cur_m, station, _i, _len, _ref;
        _ref = this.List;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          station = _ref[_i];
          cur_m = L.marker([station["latitude"], station["longitude"]]).bindPopup(format(station)).addTo(map);
          station.marker = cur_m;
        }
        return true;
      };

      VelibList.prototype.findStation = function(num) {
        var index, station, _i, _len, _ref;
        _ref = this.List;
        for (index = _i = 0, _len = _ref.length; _i < _len; index = ++_i) {
          station = _ref[index];
          if (station["number"] === num) {
            return index;
          }
        }
        return null;
      ...
      VelibList.prototype.update = function(response) {
        return response.forEach((function(_this) {
          return function(element, index, array) {
            var curPop, curStation;
            curStation = _this.findStation(element["number"]);
            _this.List[curStation].bike_stand = element["bike_stands"];
            curPop = _this.List[curStation].marker.getPopup();
    ...
    return format = function(station) {
      var n, sName;
      sName = station["name"].replace(/\d* - /, "");
      n = sName.charAt(0).toUpperCase() + sName.slice(1).toLowerCase();
      if ((station["available_bike_stands"] == null) || (station["available_bikes"] == null)) {
        return '<p>' + n + '</p>';
      }
      return '<p>' + n + '</p>' + '<p>' + station["available_bikes"] + '/' + station["available_bike_stands"] + '</p>';
    };
  })();
  ...
  (function() {
    ...
    return start = function() {
      ...
      document.getElementById("message").onclick = function() {
        return req.makeRequest('https://api.jcdecaux.com/vls/v1/stations/?contract=Paris&apiKey=' + JcDecauxKey, model);
      };
      return true;
    };
  })();
